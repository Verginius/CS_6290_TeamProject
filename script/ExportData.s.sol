 ...
 *
 * Expected producer:
 *   script/SimulateAttacks.s.sol writes ./analysis/data/raw/attack_simulation_raw.json
 */
contract ExportData is Script {
    string private constant DEFAULT_RAW_INPUT_FILE = "./analysis/data/raw/attack_simulation_raw.json";
    string private constant OUTPUT_FILE = "./analysis/data/processed/attack_simulation_results.json";
    ...
    function run() external {
        ...
        try vm.readFile(inputFile) returns (string memory content) {
            ...
            revert("ExportData: raw simulation JSON not found; run SimulateAttacks first or set RAW_INPUT_FILE");
        }
